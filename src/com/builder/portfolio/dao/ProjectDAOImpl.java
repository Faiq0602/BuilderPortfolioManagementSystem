...
public class ProjectDAOImpl implements ProjectDAO {
    ...
    public void addProject(Project project) {
        try (Connection connection = DBConnectionUtil.getConnection();
            ...
            System.out.println("Error adding project: " + ex.getMessage());
        }
    }
    ...
    public void updateProject(Project project) {
        try (Connection connection = DBConnectionUtil.getConnection();
            ...
            System.out.println("Error updating project: " + ex.getMessage());
        }
    }
    ...
    public void deleteProject(int projectId, int builderId) {
        try (Connection connection = DBConnectionUtil.getConnection();
            ...
            System.out.println("Error deleting project: " + ex.getMessage());
        }
    }
    ...
    public List<Project> findAllProjects() {
        ...
        try (Connection connection = DBConnectionUtil.getConnection();
            ...
            System.out.println("Error listing projects: " + ex.getMessage());
        }
        return projects;
    }
    ...
    public Project findById(int projectId) {
        try (Connection connection = DBConnectionUtil.getConnection();
            ...
            System.out.println("Error finding project: " + ex.getMessage());
        }
        return null;
    }
    ...
    private List<Project> findProjectsByParameter(int id, String query) {
        ...
        try (Connection connection = DBConnectionUtil.getConnection();
            ...
            System.out.println("Error loading projects: " + ex.getMessage());
        }
        return projects;
    }
